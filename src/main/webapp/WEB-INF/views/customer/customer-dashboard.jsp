...
<%@ page import="CustomerJSP.utils.UrlUtils" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="shortcut icon" href="add.ico" type="image/x-icon">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="styles.css">
</head>
<body class="container fluid">
    <h1 class="text-primary m-2; text-center"><i class="fa fa-user" aria-hidden="true"></i> Customer Dashboard Page</h1>
    <a href="<%=request.getContextPath() + UrlUtils.CUSTOMER_ADD %>"
    	class="btn btn-primary text-while p-2 mb-3">
    		<i class="fa fa-plus" aria-hidden="true"> Add</i>
    </a>
    <table class="table table-bordered">
        <thead class="text-primary m-2">
            <tr>
                <th>Code</th>
                <th>Name</th>
                <th>Email</th>
